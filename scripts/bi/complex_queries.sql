-- Complex BI queries for Berka gold layer (Trino)
...
SELECT
  ...
  GREATEST(
    COALESCE(la.last_loan_date, DATE '1900-01-01'),
    COALESCE(CAST(oa.last_order_ts AS DATE), DATE '1900-01-01'),
    COALESCE(ta.last_trans_date, DATE '1900-01-01')
